/**
 * Mirrors vehapiproxi/src/categorize.js so UI/catalog sync and worker normalization share one taxonomy.
 */
export function normalizeCategoryParams(
    title: string,
    parentBucketRaw: string,
    bucketRaw: string
): { rootName: string; subName: string } {
    ...
    const parentBucket = parentBucketRaw || 'Other';
    const bucket = bucketRaw || 'Uncategorized';
    ...
    if (isOther || subName === rootName || subName === parentBucket || !subName) {
        if (bucket === 'Procedures' && safeTitle.includes(':')) {
            ...
            if (lowerTitle.includes('brake') || lowerTitle.includes('abs')) subName = 'Brakes';
                ...
                lowerTitle.includes('crankshaft') ||
                lowerTitle.includes('camshaft') ||
                lowerTitle.includes('valve') ||
                lowerTitle.includes('piston') ||
                lowerTitle.includes('block') ||
                lowerTitle.includes('timing')
            )
                subName = 'Engine Mechanical';
            else if (
                lowerTitle.includes('transmission') ||
                lowerTitle.includes('clutch') ||
                lowerTitle.includes('differential') ||
                lowerTitle.includes('axle') ||
                lowerTitle.includes('driveline') ||
                lowerTitle.includes('transfer case')
            )
                subName = 'Transmission & Driveline';
            else if (
                lowerTitle.includes('sensor') ||
                lowerTitle.includes('module') ||
                lowerTitle.includes('ignition') ||
                lowerTitle.includes('spark') ||
                lowerTitle.includes('battery') ||
                lowerTitle.includes('alternator') ||
                lowerTitle.includes('starter') ||
                lowerTitle.includes('wire') ||
                lowerTitle.includes('electrical') ||
                lowerTitle.includes('relay') ||
                lowerTitle.includes('fuse')
            )
                subName = 'Electrical & Sensors';
            else if (
                lowerTitle.includes('fuel') ||
                lowerTitle.includes('intake') ||
                lowerTitle.includes('exhaust') ||
                lowerTitle.includes('emission') ||
                lowerTitle.includes('throttle')
            )
                subName = 'Fuel & Emissions';
            else if (
                lowerTitle.includes('steering') ||
                lowerTitle.includes('suspension') ||
                lowerTitle.includes('wheel') ||
                lowerTitle.includes('tire') ||
                lowerTitle.includes('alignment') ||
                lowerTitle.includes('strut') ||
                lowerTitle.includes('shock')
            )
                subName = 'Steering & Suspension';
            else if (
                lowerTitle.includes('coolant') ||
                lowerTitle.includes('cooling') ||
                lowerTitle.includes('radiator') ||
                lowerTitle.includes('water pump') ||
                lowerTitle.includes('thermostat')
            )
                subName = 'Cooling System';
            else if (
                lowerTitle.includes('fluid') ||
                lowerTitle.includes('oil') ||
                lowerTitle.includes('lubricant') ||
                lowerTitle.includes('capacity')
            )
                subName = 'Fluids & Maintenance';
            else if (
                lowerTitle.includes('body') ||
                lowerTitle.includes('door') ||
                lowerTitle.includes('window') ||
                lowerTitle.includes('mirror') ||
                lowerTitle.includes('seat') ||
                lowerTitle.includes('interior') ||
                lowerTitle.includes('exterior') ||
                lowerTitle.includes('bumper') ||
                lowerTitle.includes('glass') ||
                lowerTitle.includes('panel')
            )
                subName = 'Body & Interior';
            else if (
                lowerTitle.includes('air bag') ||
                lowerTitle.includes('restraint') ||
                lowerTitle.includes('seat belt')
            )
                subName = 'Restraints & Safety';

...
| Priority | Task |
|----------|------|
| **High** | Execute **`docs/plans/2026-03-21-production-readiness-paid-plus-l2.md`**: deploy verification, **rate limits**, observability, **RLS (staging)**, **L2 RAG query API** + **Angular UI** (flagged), **`media_asset`** ingest wiring, release checklist — see design `docs/plans/2026-03-21-production-readiness-paid-plus-l2-design.md`. Schema reference: `docs/plans/2026-03-18-normalization-schema-design.md`. |

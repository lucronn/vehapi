...
- Vehapiproxi Swagger: `documentation/vehapiproxi/swagger.yaml`
- M1 frontend (Angular) export: `C:\Users\mAdmin\Downloads\motor`
- M1 crawler: `m1_crawler/client.py`, `m1_crawler/crawler.py`
- Proxy config: `vehapiproxi/src/config.js`, `vehapiproxi/src/function.js` (pathRewrite)
- Extracted M1 endpoints: `m1_crawler/m1_endpoints.json`

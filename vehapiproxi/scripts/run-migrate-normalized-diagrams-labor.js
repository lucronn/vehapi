#!/usr/bin/env node
/**
 * Apply additive normalization DDL for diagrams, component locations, and labor.
 * File: documentation/migrations/20260322_normalized_diagrams_component_locations_labor.sql
 *
 *   cd vehapiproxi && npm run migrate:normalized-diagrams-labor
 */
...
const sqlPath = path.join(
    ...
    'documentation',
    'migrations',
    '20260322_normalized_diagrams_component_locations_labor.sql'
);
...
async function run() {
    ...
    try {
        ...
        console.log('Applying normalized diagrams/component-locations/labor migration...');
        await client.query(sql);
        console.log('Normalization wrap-up migration completed.');
    } catch (err) {

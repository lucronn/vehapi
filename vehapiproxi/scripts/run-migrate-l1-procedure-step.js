#!/usr/bin/env node
/**
 * Apply additive L1 procedure_step DDL.
 * File: documentation/migrations/20260322_l1_procedure_step.sql
 *
 *   cd vehapiproxi && npm run migrate:l1-procedure-step
 */
...
const sqlPath = path.join(repoRoot, 'documentation', 'migrations', '20260322_l1_procedure_step.sql');
...
async function run() {
    ...
    try {
        ...
        console.log('Applying L1 procedure_step migration (additive)...');
        await client.query(sql);
        console.log('L1 procedure_step migration completed.');
    } catch (err) {

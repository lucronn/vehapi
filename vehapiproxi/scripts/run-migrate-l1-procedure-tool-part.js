#!/usr/bin/env node
/**
 * Apply additive L1 procedure_tool + procedure_part DDL.
 * File: documentation/migrations/20260323_l1_procedure_tool_and_part.sql
 *
 *   cd vehapiproxi && npm run migrate:l1-procedure-tool-part
 */
...
const sqlPath = path.join(repoRoot, 'documentation', 'migrations', '20260323_l1_procedure_tool_and_part.sql');
...
async function run() {
    ...
    try {
        ...
        console.log('Applying L1 procedure_tool + procedure_part migration (additive)...');
        await client.query(sql);
        console.log('L1 procedure_tool + procedure_part migration completed.');
    } catch (err) {

#!/usr/bin/env node
/**
 * Apply additive DDL: ai_processing_logs prompt/completion columns + failed_extractions.
 * documentation/migrations/20260325_failed_extractions_and_ai_log_tokens.sql
 *
 *   cd vehapiproxi && npm run migrate:ai-hardening
 */
...
const sqlPath = path.join(
    ...
    'documentation',
    'migrations',
    '20260325_failed_extractions_and_ai_log_tokens.sql'
);
...
async function run() {
    ...
    try {
        ...
        console.log('Applying AI hardening migration (failed_extractions + ai_processing_logs tokens)...');
        await client.query(sql);
        console.log('AI hardening migration completed.');
    } catch (err) {
